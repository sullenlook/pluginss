...
'mustRepeat': 
    {'de-DE': [u"Entschuldigung ich hab dich leider nicht verstanden."],
     'en-GB': [u"Sorry, I did not understand, please try again", u"Sorry, I don't know what you want"]
     },
'askForMessage':
    {'de-DE': [u"Was willst du schreiben?", u"Was soll drin stehen?", u"Du kannst mir jetzt diktieren!"],
     'en-GB': [u"What do you want to say?", u"What do you want to include in the message?", u"Please dictate me the contents!"]
     },
'showUpdate': 
    {'de-DE': [u"Ich hab deine Nachricht geschrieben. Willst du sie jetzt senden?", u"OK. Willst du die Nachricht jetzt senden?"],
     'en-GB': [u"I updated your message. Ready to send it?", u"Ok, I got that, do you want to send it?", u"Thanks, do you want to send it now?"]
     },
'cancelSms': 
    {'de-DE': [u"OK, I schick sie nicht.", u"OK, ich hab sie verworfen"],
     'en-GB': [u"OK, I won't send it.", u"OK, I deleted it."]
     },
'cancelFail':
    {'de-DE': [u"Sorry, aber mir ist ein Fehler beim Abbrechen passiert"],
     'en-GB': [u"Sorry I could not properly cancel your message"]
     },
'createSmsFail':
    {'de-DE': [u"Ich konnte keine neue Nachricht anlegen, sorry"],
     'en-GB': [u"I could not create a new message, sorry!"]
     },
'updateSmsFail':
    {'de-DE': [u"Entschuldigung ich konnte die Nachricht nicht schreiben"],
     'en-GB': [u"Sorry, I could not update your message!"]
     },
'sendSms':
    {'de-DE': [u"OK, ich verschicke die Nachricht"],
     'en-GB': [u"OK, I'll send your message."]
     },
'sendSmsFail':
    {'de-DE': [u"Umpf da ist was schief gelaufen, sorry"],
     'en-GB': [u"Hm something gone wrong, I could not send the message, I'm very sorry"]
     },
'clarification':
    {'de-DE': [u"Fortfahren mit senden, abbrechen, anschauen oder ändern."],
     'en-GB': [u"To continue, you can Send, Cancel, Review, or Change it."]
     }
}
...
'_$!<Mobile>!$_': {'en-GB': u"mobile", 'de-DE': u"Handynummer"},
'iPhone': {'en-GB': u"iPhone", 'de-DE': u"iPhone-Nummer"},
'_$!<Home>!$_': {'en-GB': u"home", 'de-DE': u"Privatnummer"},
'_$!<Work>!$_': {'en-GB': u"work", 'de-DE': u"Geschäftsnummer"},
'_$!<Main>!$_': {'en-GB': u"main", 'de-DE': u"Hauptnummer"},
'_$!<HomeFAX>!$_': {'en-GB': u"home fax", 'de-DE': u'private Faxnummer'},
'_$!<WorkFAX>!$_': {'en-GB': u"work fax", 'de-DE': u"geschäftliche Faxnummer"},
'_$!<OtherFAX>!$_': {'en-GB': u"_$!<OtherFAX>!$_", 'de-DE': u"_$!<OtherFAX>!$_"},
'_$!<Pager>!$_': {'en-GB': u"pager", 'de-DE': u"Pagernummer"},
'_$!<Other>!$_':{'en-GB': u"other phone", 'de-DE': u"anderes Telefon"}
}
...
class shortMessaging(Plugin):
    ...
    @register("en-GB", ".*(text|message|sms|text message)( to)? (?P<recipient>[\w ]+?)$")
